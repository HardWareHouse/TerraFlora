<template>
  <nav
    class="flex flex-wrap items-center justify-center px-4 py-2 mb-4 cursor-pointer bg-gradient-to-r from-pink-400 to-green-500 text-black"
  >
...
const tabs = [
  ...
  { id: "refund", icon: "bi-arrow-return-left", label: "Gestion de Paiements" },
...
const components = {
  resources: defineAsyncComponent(
    () => import("./wrapperComponents/resourcesCrud.vue")
  ),
  statistics: defineAsyncComponent(
    () => import("./wrapperComponents/statistical.vue")
  ),
  contacts: defineAsyncComponent(
    () => import("./wrapperComponents/contacts.vue")
  ),
